...
def extract_frustum_data(idx_filename, split, output_filename,dataset_path, viz=False,
    ...
    '''
    dataset = kitti_object(dataset_path, split)
...
def get_box3d_dim_statistics(dataset_path,idx_filename):
...
def extract_frustum_data_rgb_detection(det_filename, split, output_filename,dataset_path,
                                       viz=False,
                                       type_whitelist=['Car'],
...
def write_2d_rgb_detection(dataset_path,det_filename, split, result_dir):
...
if __name__=='__main__':
    ...
    parser.add_argument('--dataset_path',default=None,help='Path of kitti directory',required=True)
